...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Usar AppendText en lugar de concatenar texto (+=) evita asignaciones de memoria O(N^2),
                // lo que mejora drásticamente el rendimiento durante actualizaciones frecuentes de log.
