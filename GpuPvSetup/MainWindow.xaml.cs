    ...
    public partial class MainWindow : Window
    {
        ...
        private void CopyDirectory(string sourceDir, string destinationDir, IProgress<string> progress, Stopwatch? stopwatch = null)
        {
            ...
            foreach (FileInfo file in files)
            {
                ...
                // ⚡ Bolt: Throttling UI updates to ~100ms reduces thread context switches and improves copy performance
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Using AppendText() prevents O(N^2) string allocations that slow down the UI
