    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureGpuPvAsync(string vmName, IProgress<string> progress)
        {
            ...
            try
            {
                ...
                var envVarsVhdx = new Dictionary<string, string> { { "TARGET_VHDX", vhdxPath } };
                ...
                string scriptMount = @"
                    ...
                    $vol.DriveLetter
                ";
                string driveLetter = RunPowerShellCommand(scriptMount, envVarsVhdx).Trim();
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(mountPath))
                {
                    ...
                    {
                         var envVarsVhdxFinally = new Dictionary<string, string> { { "TARGET_VHDX", vhdxPath } };
                         RunPowerShellCommand("Dismount-VHD -Path $env:TARGET_VHDX", envVarsVhdxFinally);
