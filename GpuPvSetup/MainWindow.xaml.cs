...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ⚡ Bolt Optimization: TextBox.Clear() avoids memory allocations of re-assigning strings
            LogTextBox.Clear();
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt Optimization: TextBox.AppendText() avoids O(N^2) memory allocations of string concatenation (+=)
