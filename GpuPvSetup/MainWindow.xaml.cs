...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            LogTextBox.Clear(); // ⚡ Bolt: Usamos Clear() para evitar asignación de strings vacíos
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Usamos AppendText en lugar de concatenación para evitar asignaciones O(N^2)
