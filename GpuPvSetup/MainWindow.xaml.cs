...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // Optimización: Usamos TextBox.AppendText() en lugar de concatenar strings en TextBlock.Text (+=)
                // para prevenir asignaciones de memoria O(N^2) y cuellos de botella en el rendimiento del hilo de la UI.
