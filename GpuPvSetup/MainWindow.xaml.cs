...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // Optimización de rendimiento: Usar TextBox.AppendText previene las asignaciones
                // de memoria O(N^2) que ocurren al concatenar strings (+=) en TextBlock.Text,
                // evitando bloqueos en el hilo de la UI al realizar actualizaciones frecuentes.
