    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureGpuPvAsync(string vmName, IProgress<string> progress)
        {
            ...
            try
            {
                ...
                envVars["TARGET_VHDX_PATH"] = vhdxPath;
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(mountPath))
                {
                    ...
                    {
                         envVars["TARGET_VHDX_PATH"] = vhdxPath;
                         RunPowerShellCommand("Dismount-VHD -Path $env:TARGET_VHDX_PATH", envVars);
            ...
            using (var searcher = new ManagementObjectSearcher("SELECT * FROM Win32_VideoController"))
            {
                foreach (ManagementObject obj in searcher.Get())
                {
                    ...
                    string script = $@"
                        ...
                        $gpuPattern = '*' + $env:GPU_NAME + '*'
                        $gpu = Get-CimInstance Win32_VideoController | Where-Object {{ $_.Name -like $gpuPattern }} | Select-Object -First 1
                        if ($gpu) {{
