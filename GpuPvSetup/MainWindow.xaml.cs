...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void CopyDirectory(string sourceDir, string destinationDir, IProgress<string> progress, Stopwatch throttleTimer = null)
        {
            ...
            {
                throttleTimer = Stopwatch.StartNew();
            }
            ...
            foreach (FileInfo file in files)
            {
                ...
                // ⚡ Bolt: Throttling IProgress reports using a Stopwatch (100ms threshold)
                // to reduce UI thread context switches and improve copy performance.
            ...
            foreach (DirectoryInfo subDir in dirs)
            {
                ...
                CopyDirectory(subDir.FullName, newDestinationDir, progress, throttleTimer); // No mostramos sub-progreso para simplificar
            }
        }
