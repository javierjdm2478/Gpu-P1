...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // Optimización: Usamos AppendText en lugar de += para evitar asignaciones
                // de memoria O(N^2) y cuellos de botella en el hilo de la UI durante
                // actualizaciones frecuentes de registros.
