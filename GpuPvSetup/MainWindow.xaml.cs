...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureGpuPvAsync(string vmName, IProgress<string> progress)
        {
            ...
            // Security: Sanitize vmName to prevent PowerShell command injection
            ...
            try
            {
                ...
                // Security: Sanitize vhdxPath to prevent PowerShell command injection
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(mountPath))
                {
                    ...
                    {
                         string safeDismountVhdxPath = vhdxPath.Replace("'", "''");
                         RunPowerShellCommand($"Dismount-VHD -Path '{safeDismountVhdxPath}'");
