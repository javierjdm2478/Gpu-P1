    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureGpuPvAsync(string vmName, IProgress<string> progress)
        {
            ...
            try
            {
                ...
                {
                    wasVmRunning = true;
                    progress.Report($"La VM '{safeVmName}' está encendida. Apagando suavemente...");
                ...
                string safeVhdxPath = vhdxPath?.Replace("'", "''") ?? string.Empty;
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(mountPath))
                {
                    ...
                    if (!string.IsNullOrEmpty(safeVhdxPath))
                    {
                ...
                if (wasVmRunning)
                {
                    progress.Report($"Reiniciando la VM '{safeVmName}' automáticamente...");
