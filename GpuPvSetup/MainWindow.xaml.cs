...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ⚡ Bolt Optimization: Use Clear() instead of assigning an empty string to avoid unnecessary allocations
            LogTextBox.Clear();
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt Optimization: TextBox.AppendText() prevents O(N^2) memory allocations from string concatenation
