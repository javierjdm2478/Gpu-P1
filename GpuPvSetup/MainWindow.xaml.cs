...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // Bolt: Utilizando AppendText en lugar de concatenar (+=) para evitar asignaciones
                // de memoria O(N^2) que causan problemas de rendimiento significativos, especialmente
                // cuando se reportan muchos mensajes de progreso.
