    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConfigureGpuPvAsync(string vmName, IProgress<string> progress)
        {
            ...
            try
            {
                ...
                var vhdxEnvVars = new Dictionary<string, string> { { "VHDX_PATH", vhdxPath } };
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(mountPath))
                {
                    ...
                    {
                         var vhdxDismountEnvVars = new Dictionary<string, string> { { "VHDX_PATH", vhdxPath } };
                         RunPowerShellCommand("Dismount-VHD -Path $env:VHDX_PATH", vhdxDismountEnvVars);
