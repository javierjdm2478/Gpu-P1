...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        {
            // Prevención de inyección de comandos en PowerShell pasando los argumentos como variables de entorno
            ...
            try
            {
                ...
                // Prevención de inyección para vhdxPath pasándolo mediante variables de entorno
