...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // Optimización Bolt: Se utiliza TextBox.AppendText() en lugar de concatenar en un TextBlock
                // para evitar asignaciones de memoria O(N^2) que degradan el rendimiento severamente.
