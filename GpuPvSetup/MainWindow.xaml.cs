...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ⚡ Bolt: Usamos Clear() en lugar de asignación de string vacío para mejor rendimiento
            LogTextBox.Clear();
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Usar AppendText evita asignaciones de memoria O(N^2) que ocurren al concatenar strings con +=
