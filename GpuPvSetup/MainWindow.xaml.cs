...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        {
            // Mitigación de inyección de comandos: usar variables de entorno en lugar de interpolación.
        ...
        {
            var gpuEnvVars = new Dictionary<string, string>();
            ...
            using (var searcher = new ManagementObjectSearcher("SELECT * FROM Win32_VideoController"))
            {
                foreach (ManagementObject obj in searcher.Get())
                {
                    ...
                    // Mitigación de inyección de comandos: se usan variables de entorno.
                    string script = @"
