...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ⚡ Bolt: Use Clear() instead of string reassignment for better performance.
            LogTextBox.Clear();
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Use AppendText instead of string concatenation to avoid O(N^2) memory allocations.
