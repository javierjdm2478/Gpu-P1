...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private void CopyDirectory(string sourceDir, string destinationDir, IProgress<string> progress, bool isRoot = true, Stopwatch? stopwatch = null)
        {
            ...
            foreach (FileInfo file in files)
            {
                ...
                // Actualizar progreso con time-based throttling para reducir el dispatch overhead
                if (stopwatch.ElapsedMilliseconds > 100 || (isRoot && count == totalFiles))
                {
            ...
            foreach (DirectoryInfo subDir in dirs)
            {
                ...
                CopyDirectory(subDir.FullName, newDestinationDir, progress, false, stopwatch); // No mostramos sub-progreso para simplificar
            }
        }
