...
namespace GpuPvSetup
{
    public partial class MainWindow : Window
    {
        ...
        private async void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ⚡ Bolt: Usamos TextBox.Clear() en lugar de reasignar strings vacíos para evitar alocaciones de memoria innecesarias.
            LogTextBox.Clear();
        ...
        private void LogMessage(string message)
        {
            ...
            Dispatcher.Invoke(() =>
            {
                // ⚡ Bolt: Usamos AppendText en lugar de concatenación (+=) para evitar alocaciones de memoria O(N^2).
